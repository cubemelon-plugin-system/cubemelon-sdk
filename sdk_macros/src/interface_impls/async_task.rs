...
fn generate_interface_implementation(struct_name: &Ident) -> TokenStream2 {
    quote! {
        // Add methods to the main plugin implementation to support AsyncTaskInterface
        impl #struct_name {
            /// Get interface implementation for AsyncTask
            /// 
            /// This method should be called from the main get_interface implementation
            /// when PLUGIN_TYPE_ASYNC_TASK is requested.
            /// 
            ...
            ///         return self.async_task_interface(interface_version);
            ///     }
            ///     
            ...
            pub fn async_task_interface(
                ...
                let interface = ::cubemelon_sdk::interfaces::async_task::create_async_task_interface::<#struct_name>();
