...
fn generate_interface_implementation(struct_name: &Ident) -> TokenStream2 {
    quote! {
        // Add methods to the main plugin implementation to support PluginManagerInterface
        impl #struct_name {
            /// Get interface implementation for PluginManager
            /// 
            /// This method should be called from the main get_interface implementation
            /// when PLUGIN_TYPE_MANAGER is requested.
            /// 
            ...
            ///         return self.manager_interface(interface_version);
            ///     }
            ///     
            ...
            pub fn manager_interface(
                ...
                let interface = ::cubemelon_sdk::interfaces::manager::create_manager_interface::<#struct_name>();
