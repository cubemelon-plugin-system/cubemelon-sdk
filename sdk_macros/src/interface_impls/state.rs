...
fn generate_interface_implementation(struct_name: &Ident) -> TokenStream2 {
    quote! {
        // Add methods to the main plugin implementation to support StateInterface
        impl #struct_name {
            /// Get interface implementation for State
            /// 
            /// This method should be called from the main get_interface implementation
            /// when PLUGIN_TYPE_STATE is requested.
            /// 
            ...
            ///         return self.state_interface(interface_version);
            ///     }
            ///     
            ...
            pub fn state_interface(
                ...
                let interface = ::cubemelon_sdk::interfaces::state::create_state_interface::<#struct_name>();
